  ...
  markets: MarketCardItem[] = [
    {
      ...
      price: 600,
      slots: [
        { date: '06/04', remaining: 15 },
        { date: '06/20', remaining: 8 },
      ],
    },
    {
      title: '台北精品咖啡生活節',
      ...
      price: 600,
      slots: [
        { date: '05/24', remaining: 15 },
        { date: '05/26', remaining: 5 },
      ],
    },
    {
      title: '手作設計市集',
      ...
      price: 600,
      slots: [
        { date: '05/25', remaining: 6 },
        { date: '06/26', remaining: 1 },
      ],
    },
    {
      title: '山系生活戶外市集',
      ...
      price: 600,
      slots: [
        { date: '05/07', remaining: 13 },
        { date: '06/09', remaining: 11 },
      ],
    },
    {
      title: '毛孩友善市集',
      ...
      price: 600,
      slots: [
        { date: '06/08', remaining: 5 },
        { date: '06/09', remaining: 1 },
      ],
    },
    {
      title: '植感生活市集',
      ...
      price: 600,
      slots: [
        { date: '06/15', remaining: 7 },
        { date: '06/16', remaining: 12 },
      ],
    },
    {
      title: '城市甜點生活市集',
      ...
      price: 600,
      slots: [
        { date: '07/05', remaining: 16 },
        { date: '07/07', remaining: 9 },
      ],
    },
    {
      title: '親子童趣假日市集',
      ...
      price: 600,
      slots: [
        { date: '07/12', remaining: 15 },
        { date: '07/14', remaining: 15 },
      ],
    },
    {
      title: '夏夜音樂手作市集',
      ...
      price: 600,
      slots: [
        { date: '07/19', remaining: 5 },
        { date: '07/21', remaining: 6 },
      ],
    },
    {
      title: '港邊海風選物市集',
      ...
      price: 600,
      slots: [
        { date: '08/02', remaining: 15 },
        { date: '08/04', remaining: 8 },
      ],
    },
    {
      title: '植物療癒週末市集',
      ...
      price: 600,
      slots: [
        { date: '08/10', remaining: 15 },
        { date: '08/11', remaining: 15 },
      ],
    },
    {
      title: '毛孩夏日派對市集',
